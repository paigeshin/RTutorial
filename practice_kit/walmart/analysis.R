...
walmart_data = read.csv('/Users/paige/Desktop/R Tutorial/data/walmart_data.csv')
walmart_features = read.csv('/Users/paige/Desktop/R Tutorial/data/walmart_features.csv')
